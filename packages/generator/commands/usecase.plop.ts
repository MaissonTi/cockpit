  ...
  plop.setGenerator('Create UseCase', {
    ...
    prompts: [
      ...
      },
      {
        ...
        when: answers =>
          answers.create_controller || answers.is_connection_controller,
        choices: () => {
    ...
    actions: function (data) {
      ...
      actions.push({
        ...
        path: path.resolve(
          ROOT_MONOREPO,
          'apps/api/src/app/usecases',
          '{{ kebabCase (or selected_module usecase_name) }}',
          '{{kebabCase usecase_name}}.usecase.ts',
        ),
      ...
      actions.push({
        ...
        path: path.resolve(
          ...
          '{{ kebabCase (or selected_module usecase_name) }}',
          '{{kebabCase usecase_name}}.usecase.interface.ts',
        ),
      ...
      if (!data?.is_connection_module) {
        actions.push({
          ...
          path: path.resolve(
            ...
            'apps/api/src/app/usecases',
            '{{ kebabCase (or selected_module usecase_name) }}',
            '_{{kebabCase usecase_name}}.module.ts',
          ),
      ...
      if (data?.create_controller) {
        actions.push({
          ...
          templateFile:
            'templates/backend/usecase-only/usecase.controller.ts.hbs',
          skipIfExists: true,
        });
