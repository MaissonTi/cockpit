    ...
    actions: function (data) {
      ...
      actions.push({
        ...
        path: path.resolve(
          ...
          '{{kebabCase usecase_name}}.model.ts',
        ),
      ...
      actions.push({
        ...
        path: path.resolve(
          ROOT_MONOREPO,
          'apps/api/src/domain/protocols/database/repositories',
          '{{kebabCase usecase_name}}.repository.interface.ts',
        ),
        templateFile:
          'templates/backend/crud/database/repository.interface.hbs',
        skipIfExists: true,
      });
      ...
      actions.push({
        ...
        path: path.resolve(
          ...
          '{{kebabCase usecase_name}}.repository.ts',
        ),
      ...
      actions.push({
        ...
        path: path.resolve(
          ROOT_MONOREPO,
          'apps/api/src/infra/database/prisma/mapper',
          '{{kebabCase usecase_name}}.mapper.ts',
        ),
      ...
      actions.push({
        ...
        path: path.resolve(
          ROOT_MONOREPO,
          'apps/api/src/infra/database/prisma',
          'schema.prisma',
        ),
      ...
      actions.push({
        ...
        destination: path.resolve(
          ROOT_MONOREPO,
          'apps/api/src/app/usecases',
          '{{kebabCase usecase_name}}',
        ),
      ...
      actions.push({
        ...
        destination: path.resolve(
          ROOT_MONOREPO,
          'apps/api/test/unit/app/usecases',
          '{{kebabCase usecase_name}}',
        ),
        base: 'templates/backend/crud/usecase.test',
        templateFiles:
          'templates/backend/crud/usecase.test/*.usecase.spec.ts.hbs',
        skipIfExists: true,
      });
      ...
      actions.push({
        ...
        path: path.resolve(
          ROOT_MONOREPO,
          'apps/api/test/_mock/model',
          '{{kebabCase usecase_name}}.mock.ts',
        ),
      ...
      actions.push({
        ...
        path: path.resolve(
          ROOT_MONOREPO,
          'apps/api/test/_mock/repository',
          '{{kebabCase usecase_name}}.repository.mock.ts',
        ),
        templateFile:
          'templates/backend/crud/usecase.test/repository.mock.ts.hbs',
        skipIfExists: true,
      });
      ...
      actions.push({
        ...
        path: path.resolve(
          ROOT_MONOREPO,
          'apps/api/src/presentation/http/controllers',
          '{{kebabCase usecase_name}}.controller.ts',
        ),
      ...
      actions.push({
        ...
        path: path.resolve(
          ROOT_MONOREPO,
          'apps/api/src/presentation/http/presenters',
          '{{kebabCase usecase_name}}.presenter.ts',
        ),
