...
export default function (plop: NodePlopAPI) {
	plop.setGenerator('Create CRUD', {
		description: 'Create a new CRUD package inside `./backend` folder',
		prompts: [
      {
        type: "input",
        name: "usecase_name",
    ...
    actions: function(data) {
      ...
      actions.push({
        type: "add",
        path: path.resolve(ROOT_MONOREPO, "apps/backend/src/domain/models", "{{kebabCase usecase_name}}.model.ts"),
      ...
      actions.push({
        type: "add",
        path: path.resolve(ROOT_MONOREPO, "apps/backend/src/domain/protocols/database/repositories", "{{kebabCase usecase_name}}.repository.interface.ts"),
      ...
      actions.push({
        type: "add",
        path: path.resolve(ROOT_MONOREPO, "apps/backend/src/infra/database/prisma/repositories", "{{kebabCase usecase_name}}.repository.ts"),
      ...
      actions.push({
        type: "add",
        path: path.resolve(ROOT_MONOREPO, "apps/backend/src/infra/database/prisma/mapper", "{{kebabCase usecase_name}}.mapper.ts"),
      ...
      actions.push({
        type: "append",
        path: path.resolve(ROOT_MONOREPO, "apps/backend/src/infra/database/prisma", "schema.prisma"),
      ...
      actions.push({
        type: "addMany",
        destination: path.resolve(ROOT_MONOREPO, "apps/backend/src/app/usecases", "{{kebabCase usecase_name}}"),
      ...
      actions.push({
        type: "addMany",
        destination: path.resolve(ROOT_MONOREPO, "apps/backend/src/domain/usecases", "{{kebabCase usecase_name}}"),
      ...
      actions.push({
        type: "addMany",
        destination: path.resolve(ROOT_MONOREPO, "apps/backend/test/unit/app/usecases", "{{kebabCase usecase_name}}"),
      ...
      actions.push({
        type: "add",
        path: path.resolve(ROOT_MONOREPO, "apps/backend/test/_mock/model", "{{kebabCase usecase_name}}.mock.ts"),
      ...
      actions.push({
        type: "add",
        path: path.resolve(ROOT_MONOREPO, "apps/backend/test/_mock/repository", "{{kebabCase usecase_name}}.repository.mock.ts"),
      ...
      actions.push({
        type: "add",
        path: path.resolve(ROOT_MONOREPO, "apps/backend/src/presentation/http/presenters", "{{kebabCase usecase_name}}.presenter.ts"),
      ...
      actions.push({
        type: "add",
        path: path.resolve(ROOT_MONOREPO, "apps/backend/.http", "{{kebabCase usecase_name}}.http"),
